...
export async function writeCommandDocumentation(command: CommandWithMarkdown) {
...
export async function writeCommandFlagInterface(command: oclifCommand.Loadable) {
