...
Update base.css file with a visible change, something like * { background: #050 !important }
Check in the Chrome Console if the hot reload logs appear, to be sure the page wasn't fully refreshed
...
Check if the templates/index.json file is updated
Stop the development server with CTRL+C
