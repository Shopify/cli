...
USAGE
  $ shopify app dev [--checkout-cart-url <value>] [--client-id <value> | -c <value>]
    ...
    [--notify <value>] [--path <value>] [--reset | ] [--skip-dependencies-installation] [-s <value>]
    [--subscription-product-url <value>] [-t <value>] [--theme-app-extension-port <value>] [--use-localhost |
