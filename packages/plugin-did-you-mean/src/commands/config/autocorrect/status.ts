...
export default class AutocorrectStatus extends Command {
  static summary = 'Check whether autocorrect is enabled or disabled. Off by default.'

  static descriptionWithMarkdown = `Check whether autocorrect is enabled or disabled. Off by default.
