...
export function resolveSecurityConfigFileName(directory: string, configName?: string): string {
...
export function requireSecurityConfigFileName(directory: string, configName?: string): string {
  const configFileName = resolveSecurityConfigFileName(directory, configName)
