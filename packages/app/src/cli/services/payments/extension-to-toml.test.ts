...
const SAMPLE_CARD_PRESENT_CONFIG =
  '{"start_payment_session_url":"https://bogus-payment-sessions.shopifycloud.com/bogus/card_present/payment_sessions","start_refund_session_url":"https://bogus-payment-sessions.shopifycloud.com/bogus/card_present/refund_sessions","start_capture_session_url":"https://bogus-payment-sessions.shopifycloud.com/bogus/card_present/capture_sessions","start_void_session_url":"https://bogus-payment-sessions.shopifycloud.com/bogus/card_present/void_sessions","supported_payment_methods":["visa","master","american_express"],"supported_countries":["AU","CA","GB","US"],"test_mode_available":true,"merchant_label":"Card Present Payments App Extension","api_version":"2025-04"}'
