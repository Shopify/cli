...
describe('pollAppLogs', () => {
  ...
  test('polls and re-polls the endpoint', async () => {
    ...
    expect(stdout.write).toHaveBeenNthCalledWith(3, expect.stringContaining('Open log file'))
    ...
    expect(stdout.write).toHaveBeenNthCalledWith(6, expect.stringContaining('Open log file'))

    // app_logs[2]
    expect(stdout.write).toHaveBeenNthCalledWith(7, 'Function network access request executed successfully.')
    expect(stdout.write).toHaveBeenNthCalledWith(8, expect.stringContaining('Open log file'))
    ...
    expect(stdout.write).toHaveBeenNthCalledWith(10, expect.stringContaining('Open log file'))

    // app_logs[4]
    expect(stdout.write).toHaveBeenNthCalledWith(11, 'Function network access response retrieved from cache.')
    expect(stdout.write).toHaveBeenNthCalledWith(12, expect.stringContaining('Open log file'))
    ...
    expect(stdout.write).toHaveBeenNthCalledWith(14, expect.stringContaining('Open log file'))
    ...
    expect(stdout.write).toHaveBeenNthCalledWith(16, expect.stringContaining('Open log file'))

    // app_logs[7]
    expect(stdout.write).toHaveBeenNthCalledWith(17, JSON.stringify(OTHER_PAYLOAD))
    expect(stdout.write).toHaveBeenNthCalledWith(18, expect.stringContaining('Open log file'))
