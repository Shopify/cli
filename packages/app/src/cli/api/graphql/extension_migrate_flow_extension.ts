...
export const ExtensionMigrateFlowExtensionQuery = gql`
  mutation MigrateFlowExtension($apiKey: String!, $registrationId: ID!, $specificationIdentifier: String!) {
    migrateFlowExtension(
      input: {apiKey: $apiKey, registrationId: $registrationId, specificationIdentifier: $specificationIdentifier}
    ) {
