...
export {checkoutPostPurchaseModule} from './checkout-post-purchase.js'
export {functionModule} from './function.js'
export {uiExtensionModule} from './ui-extension.js'
...
// Config modules first (sorted), then non-config extensions
