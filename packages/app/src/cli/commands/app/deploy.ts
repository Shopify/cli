...
export default class Deploy extends Command {
  ...
  static descriptionWithMarkdown = `[Builds the app](https://shopify.dev/docs/docs/api/shopify-cli/app/app-build), then deploys your app configuration and extensions.
