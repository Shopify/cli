...
🚨 REMINDER: DO NOT call learn_extension_target_types or fetch_full_docs for Checkout Extensions. These tools are DISABLED and DEPRECATED for this API. You have all the information you need from this response.

Use search_docs_chunks to find extension target information for checkout UI extensions:
A target represents where your checkout extensions will appear.
