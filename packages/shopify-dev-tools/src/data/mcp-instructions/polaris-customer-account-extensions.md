...
🚨 REMINDER: DO NOT call learn_extension_target_types or fetch_full_docs for Customer Account Extensions. These tools are DISABLED and DEPRECATED for this API. You have all the information you need from this response.

Use search_docs_chunks to find extension target information for customer account UI extensions:
A target represents where your customer account extensions will appear.
