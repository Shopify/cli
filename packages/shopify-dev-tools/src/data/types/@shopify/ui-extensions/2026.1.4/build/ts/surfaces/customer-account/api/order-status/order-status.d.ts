...
/**
 * A [metafield](/docs/apps/build/custom-data/metafields) associated with the order, identified by a namespace and key.
 *
 * @deprecated Use `AppMetafieldEntry` instead.
 */
export interface Metafield {
    /**
     * The identifier for the metafield within its namespace, such as `'ingredients'` or `'rating'`.
     */
    key: string;
    /**
    ...
    value: string | number;
    /**
     * The data type of the metafield value. Determines how the `value` field should be interpreted:
     *
...
export interface OrderStatusApi<Target extends ExtensionTarget> {
    ...
    /**
     * The [metafields](/docs/apps/build/custom-data/metafields) associated with the order. These metafields are shared across all extensions and persist throughout the checkout session.
     *
     * @deprecated Use `appMetafields` instead, which provides richer data including the resource type and metafield content type.
     */
