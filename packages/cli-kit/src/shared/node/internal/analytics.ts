import {getLastSeenAuthMethod} from '../../../identity/core/session.js'
import {hashString} from '../crypto.js'
import {getPackageManager, packageManagerFromUserAgent} from '../node-package-manager.js'
import BaseCommand from '../base-command.js'
import {CommandContent} from '../hooks/prerun.js'
import * as metadata from '../metadata.js'
import {platformAndArch} from '../os.js'
import {ciPlatform, cloudEnvironment, macAddress} from '../context/local.js'
import {cwd} from '../path.js'
import {currentProcessIsGlobal} from '../is-global.js'
import {isWsl} from '../system.js'
