import {MetricInstrumentType, OtelService} from '../../vendor/otel-js/service/types.js'
import {outputContent, outputDebug, outputToken} from '../output.js'
import {
  DefaultOtelService,
  DefaultOtelServiceOptions,
} from '../../vendor/otel-js/service/DefaultOtelService/DefaultOtelService.js'
import {isUnitTest, opentelemetryDomain} from '../context/local.js'
