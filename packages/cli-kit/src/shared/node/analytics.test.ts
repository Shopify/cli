...
import * as store from './internal/analytics/storage.js'
import {startAnalytics} from './internal/analytics.js'
import {hashString} from './crypto.js'
import {CLI_KIT_VERSION} from '../common/version.js'
import {setLastSeenAuthMethod, setLastSeenUserIdAfterAuth} from '../../identity/core/session.js'
import {test, expect, describe, vi, beforeEach, afterEach, MockedFunction} from 'vitest'

vi.mock('./context/local.js')
vi.mock('./os.js')
vi.mock('../../store.js')
vi.mock('./internal/analytics/storage.js')
vi.mock('./crypto.js')
vi.mock('../../version.js')
vi.mock('./monorail.js')
vi.mock('./cli.js')
