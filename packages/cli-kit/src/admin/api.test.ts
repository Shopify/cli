import * as admin from './api.js'
import {graphqlRequest, graphqlRequestDoc} from '../shared/node/api/graphql.js'
import {AdminSession} from '../identity/session.js'
import {buildHeaders} from '../shared/node/internal/api/headers.js'
import * as http from '../shared/node/http.js'
import {defaultThemeKitAccessDomain} from '../shared/node/internal/constants.js'
import {test, vi, expect, describe} from 'vitest'

vi.mock('../shared/node/api/graphql.js')
vi.mock('../shared/node/internal/api/headers.js')
vi.mock('../shared/node/http.js')
