import {appDevRequestDoc} from './api.js'
import {graphqlRequestDoc} from '../shared/node/api/graphql.js'
import {serviceEnvironment, Environment} from '../shared/node/internal/context/service.js'
import {test, vi, expect, describe} from 'vitest'
import {TypedDocumentNode} from '@graphql-typed-document-node/core'

vi.mock('../shared/node/api/graphql.js')
vi.mock('../shared/node/internal/context/service.js')

const shopFqdn = 'test-shop.shop.dev'
const mockedToken = 'token'

vi.mock('../shared/vendor/dev_server/index.js', () => {
  return {
    DevServerCore: class {
