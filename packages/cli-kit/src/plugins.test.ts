...
describe('getListOfExtensionSpecs', () => {
  it('returns empty list when there are no extension specs', async () => {
    // Given
    const config = new Config({root: ''})
    vi.spyOn(config, 'runHook').mockResolvedValue({successes: [], errors: []} as any)
  ...
  it('returns list of extension specs', async () => {
    // Given
    const config = new Config({root: ''})
    vi.spyOn(config, 'runHook').mockResolvedValue({
      successes: [
...
describe('getListOfExtensionPoints', () => {
  it('returns empty list when there are no extension points', async () => {
    // Given
    const config = new Config({root: ''})
    vi.spyOn(config, 'runHook').mockResolvedValue({successes: [], errors: []} as any)
  ...
  it('returns list of extension points', async () => {
    // Given
    const config = new Config({root: ''})
    vi.spyOn(config, 'runHook').mockResolvedValue({
      successes: [
