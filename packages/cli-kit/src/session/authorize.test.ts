...
import {authorize, CodeAuthResult, MismatchStateError} from './authorize'
...
describe('authorize', () => {
  it('authorizes the user through the browser', async () => {
    ...
    // Then
    const url =
      'http://accounts.shopify.com/oauth/authorize?client_id=fbdb2649-e327-4907-8f67-908d24cfd7e3&scope=scope1+scope2&redirect_uri=http%3A%2F%2F127.0.0.1%3A3456&state=state&response_type=code&code_challenge_method=S256&code_challenge=challenge'
