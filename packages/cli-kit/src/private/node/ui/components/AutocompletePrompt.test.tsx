...
describe('AutocompletePrompt', async () => {
  ...
  test("doesn't submit if there are no choices", async () => {
    ...
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot(`
      "?  Associate your project with the org Castile Ventures?   [36ma[46m[36m█[39m[36m[49m[39m
  ...
  test('allows searching with pagination', async () => {
    ...
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot(`
      "?  Associate your project with the org Castile Ventures?   [36mi[46m[36m█[39m[36m[49m[39m
