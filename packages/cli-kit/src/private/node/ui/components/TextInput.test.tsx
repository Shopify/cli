...
describe('TextInput', () => {
  test('default state', () => {
    ...
    expect(lastFrame()).toMatchInlineSnapshot('"[36m[46m[36m█[39m[36m[49m[39m"')
  })
  ...
  test('displays value with cursor', () => {
    ...
    expect(lastFrame()).toMatchInlineSnapshot('"[36mHello[46m[36m█[39m[36m[49m[39m"')
  })
  ...
  test('moves the cursor with arrows', async () => {
    ...
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36mHello[46m[36m█[39m[36m[49m[39m"')
  ...
  test('moves the cursor when deleting', async () => {
    ...
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36mHell[46m[36m█[39m[36m[49m[39m"')
    await sendInputAndWaitForChange(renderInstance, DELETE)
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36mHel[46m[36m█[39m[36m[49m[39m"')
    await sendInputAndWaitForChange(renderInstance, DELETE)
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36mHe[46m[36m█[39m[36m[49m[39m"')
    await sendInputAndWaitForChange(renderInstance, DELETE)
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36mH[46m[36m█[39m[36m[49m[39m"')
    await sendInputAndWaitForChange(renderInstance, DELETE)
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36m[46m[36m█[39m[36m[49m[39m"')
  ...
  test('adjusts cursor when text is shorter than last value', async () => {
    ...
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36m[46m[36m█[39m[36m[49m[39m"')
    await sendInputAndWaitForChange(renderInstance, 'A')
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36mA[46m[36m█[39m[36m[49m[39m"')
    await sendInputAndWaitForChange(renderInstance, 'B')
    expect(renderInstance.lastFrame()).toMatchInlineSnapshot('"[36mAB[46m[36m█[39m[36m[49m[39m"')
  })
