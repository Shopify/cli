...
export type API = 'admin' | 'storefront-renderer' | 'partners' | 'business-platform' | 'developer-dashboard'

export const allAPIs: API[] = ['admin', 'storefront-renderer', 'partners', 'business-platform', 'developer-dashboard']
