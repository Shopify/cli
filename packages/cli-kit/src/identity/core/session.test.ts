...
import {store as storeSessions, fetch as fetchSessions, remove as secureRemove} from './store.js'
import {ApplicationToken, IdentityToken, Sessions} from './schema.js'
import {validateSession} from './validate.js'
import {applicationId} from './identity.js'
import {pollForDeviceAuthorization, requestDeviceAuthorization} from './device-authorization.js'
import {getCurrentSessionId} from '../../shared/node/internal/conf-store.js'
import * as fqdnModule from '../../shared/node/context/fqdn.js'
import {themeToken} from '../../shared/node/context/local.js'
import {partnersRequest} from '../../partners/api.js'
import {businessPlatformRequest} from '../../business-platform/api.js'
import {getPartnersToken} from '../../shared/node/environment.js'
import {nonRandomUUID} from '../../shared/node/crypto.js'
import {terminalSupportsPrompting} from '../../shared/node/system.js'
...
vi.mock('../../shared/node/context/local.js')
vi.mock('./identity.js')
...
vi.mock('./store.js')
vi.mock('./validate.js')
vi.mock('../../partners/api.js')
vi.mock('../../business-platform/api.js')
vi.mock('../../store')
vi.mock('../../shared/node/environment.js')
vi.mock('./device-authorization.js')
vi.mock('../../shared/node/internal/conf-store.js')
vi.mock('../../shared/node/system.js')
