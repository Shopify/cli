...
Scenario: I scaffold a post_purchase_ui extension
  ...
  Then I have a ui extension named MyExtension of type post_purchase_ui
...
Scenario: I scaffold a theme extension
  ...
  Then I have a theme extension named MyExtension of type theme_app_extension
...
Scenario: I scaffold two theme extensions
  ...
  Then I have a theme extension named MyExtension of type theme_app_extension
  Then I do not have a theme extension named MyExtension2 of type theme_app_extension
