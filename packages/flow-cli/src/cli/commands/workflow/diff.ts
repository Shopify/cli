...
import {
  ...
  readWorkflowFile,
  unifiedDiff,
} from '../../services/flow/workflow-lifecycle.js'
...
export default class FlowWorkflowDiff extends Command {
...
To inspect a remote workflow without a local file, use \`flow workflow show <id>\`.`
  ...
  static flags = {
    ...
    'local-only': Flags.boolean({
      ...
      default: false,
      env: 'SHOPIFY_FLAG_FLOW_LOCAL_ONLY',
    }),
  }
