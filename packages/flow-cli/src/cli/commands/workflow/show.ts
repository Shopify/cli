...
export default class FlowWorkflowShow extends Command {
...
To save the result, redirect to a file. To pull and create a tracked local copy with a lockfile, use \`flow workflow pull\`.`
