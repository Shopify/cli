parcelRequire = (function (e, r, t, n) {
...
})(
  {
        ...
        ;(r.prototype._version = 3),
          ...
          (r.prototype._validateMapping = function (e, n, o, t) {
            ...
            if (
              ...
              throw new Error('Invalid mapping: ' + JSON.stringify({generated: e, source: o, original: n, name: t}))
          }),
      ...
      function (require, module, exports) {
        ...
        function u(n, t) {
          ...
          this._sections = a.map(function (n) {
            ...
            return (
              (u = r),
              {generatedOffset: {generatedLine: o + 1, generatedColumn: s + 1}, consumer: new i(e.getArg(n, 'map'), t)}
            )
          })
        }
        ;(i.fromSourceMap = function (e, n) {
          ...
          (i.prototype.allGeneratedPositionsFor = function (r) {
            var t = e.getArg(r, 'line'),
              o = {source: e.getArg(r, 'source'), originalLine: t, originalColumn: e.getArg(r, 'column', 0)}
          ...
          (s.prototype.generatedPositionFor = function (n) {
            ...
            var t = {source: r, originalLine: e.getArg(n, 'line'), originalColumn: e.getArg(n, 'column')},
              o = this._findMapping(
                t,
                this._originalMappings,
                'originalLine',
        ...
        ;(i.fromStringWithSourceMap = function (n, t, o) {
          ...
          (i.prototype.walk = function (n) {
            for (var e, r = 0, t = this.children.length; r < t; r++)
              (e = this.children[r])[o]
                ? e.walk(n)
                : '' !== e && n(e, {source: this.source, line: this.line, column: this.column, name: this.name})
          }),
                ...
                ;(r.code += n),
                  null !== e.source && null !== e.line && null !== e.column
                    ? ((l === e.source && u === e.line && s === e.column && c === e.name) ||
                      ...
                      (c = e.name),
                      (i = !0))
                    : i && (o.addMapping({generated: {line: r.line, column: r.column}}), (l = null), (i = !1))
    ...
    aRf0: [
      ...
      {'./lib/source-map-generator': 'Wwhl', './lib/source-map-consumer': 'fmOz', './lib/source-node': 'Qm02'},
    ],
  },
  {},
  ['aRf0'],
