...
})(
  {
        ...
        function P(e, t, n, o, _) {
          ...
          if ((_ ? 'className' === t && (t = 'class') : 'class' === t && (t = 'className'), 'style' === t))
            if (((l = e.style), 'string' == typeof n)) l.cssText = n
              ...
              if (('string' == typeof o && ((l.cssText = ''), (o = null)), o)) for (u in o) (n && u in n) || S(l, u, '')
    ...
    tDuZ: [
      function (require, module, exports) {
        ...
        ;(exports.Vec2 = i), (i.zero = new i(0, 0)), (i.unit = new i(1, 1))
        class s {
        ...
        class e {
          ...
          withOrigin(t) {
            return new e(t, this.size)
          }
          withSize(t) {
            return new e(this.origin, t)
          }
          closestPointTo(s) {
          ...
          intersectWith(t) {
            const s = i.max(this.topLeft(), t.topLeft()),
              r = i.max(s, i.min(this.bottomRight(), t.bottomRight()))
            return new e(s, r.minus(s))
          }
          equals(t) {
        ...
        ;(exports.Rect = e),
          (e.empty = new e(i.zero, i.zero)),
          (e.unit = new e(i.zero, i.unit)),
          (e.NDC = new e(new i(-1, -1), new i(2, 2)))
      },
      {},
    ],
    pBGv: [
        ...
        ;(exports.Graphics = h),
          (function (t) {
            ...
            class e {
              ...
              equals(t) {
                return (
                  this.redF === t.redF && this.greenF === t.greenF && this.blueF === t.blueF && this.alphaF === t.alphaF
                )
              }
            }
            let i, r, s, n, h
            ;(e.TRANSPARENT = new e(0, 0, 0, 0)),
              ...
              })((i = t.BlendOperation || (t.BlendOperation = {}))),
              (function (t) {
                ;(t[(t.TRIANGLES = 0)] = 'TRIANGLES'), (t[(t.TRIANGLE_STRIP = 1)] = 'TRIANGLE_STRIP')
              })((r = t.Primitive || (t.Primitive = {})))
            function a(t) {
              return t == s.FLOAT ? 4 : 1
            }
            ;(t.Context = class {
              constructor() {
              ...
              setCopyBlendState() {
                this.setBlendState(i.ONE, i.ZERO)
              }
              setAddBlendState() {
                this.setBlendState(i.ONE, i.ONE)
              }
              setPremultipliedBlendState() {
                this.setBlendState(i.ONE, i.INVERSE_SOURCE_ALPHA)
              }
              setUnpremultipliedBlendState() {
                this.setBlendState(i.SOURCE_ALPHA, i.INVERSE_SOURCE_ALPHA)
              }
              ...
              })((s = t.AttributeType || (t.AttributeType = {}))),
            ...
            ;(t.VertexBuffer = class {
              ...
              })((n = t.PixelFilter || (t.PixelFilter = {}))),
              (function (t) {
                ;(t[(t.REPEAT = 0)] = 'REPEAT'), (t[(t.CLAMP = 1)] = 'CLAMP')
              })((h = t.PixelWrap || (t.PixelWrap = {})))
            class o {
              constructor(t, e, i) {
                ;(this.minFilter = t), (this.magFilter = e), (this.wrap = i)
              }
            }
            ;(o.LINEAR_CLAMP = new o(n.LINEAR, n.LINEAR, h.CLAMP)),
              (o.LINEAR_MIN_NEAREST_MAG_CLAMP = new o(n.LINEAR, n.NEAREST, h.CLAMP)),
              (o.NEAREST_CLAMP = new o(n.NEAREST, n.NEAREST, h.CLAMP)),
              (t.TextureFormat = o)
          })(h || (exports.Graphics = h = {})),
          (exports.WebGL = a),
          (function (t) {
            class a extends h.Context {
              get widthInPixels() {
                return this._width
              }
              get heightInPixels() {
              ...
              endFrame() {}
              setBlendState(t, e) {
                this._blendOperations = a._packBlendModes(t, e)
              }
              setViewport(t, e, i, r) {
              ...
              getANGLE_instanced_arrays() {
                if (
                  (this.ANGLE_instanced_arrays_generation !== this._generation && (this.ANGLE_instanced_arrays = null),
              ...
              _updateBlendState() {
                if (this._forceStateUpdate || this._oldBlendOperations != this._blendOperations) {
                  let t = this._gl,
                    e = this._blendOperations,
                    r = this._oldBlendOperations,
                    s = 15 & e,
                    n = e >> 4
                  i(s in this._blendOperationMap),
                    i(n in this._blendOperationMap),
                    e == a.COPY_BLEND_OPERATIONS
                      ? t.disable(t.BLEND)
                      : ((this._forceStateUpdate || r == a.COPY_BLEND_OPERATIONS) && t.enable(t.BLEND),
                        t.blendFunc(this._blendOperationMap[s], this._blendOperationMap[n])),
                    (this._oldBlendOperations = e)
                }
              }
              _updateFormat(t) {
                let e = this._gl,
            ...
            ;(a.COPY_BLEND_OPERATIONS = a._packBlendModes(h.BlendOperation.ONE, h.BlendOperation.ZERO)), (t.Context = a)
            class _ {
            ...
            class E extends _ {
              ...
              set(t, e, i, r, s, n, h, a, _) {
                ;(E._cachedValues[0] = t),
                  ...
                  (E._cachedValues[8] = _)
                for (let o = 0; o < 9; o++)
                  if (E._cachedValues[o] != this._values[o]) {
                    let t = this._values
                    ;(this._values = E._cachedValues), (E._cachedValues = t), (this._isDirty = !0)
                    break
                  }
              }
              prepare() {
            ...
            E._cachedValues = [1, 0, 0, 0, 1, 0, 0, 0, 1]
            class g extends _ {
              constructor() {
            ...
            class R extends h.VertexBuffer {
              constructor(t, e) {
                super(),
                  (this._generation = 0),
                  (this._buffer = null),
                  (this._bytes = null),
                  (this._isDirty = !0),
                  (this._dirtyMin = R.INT_MAX),
                  (this._dirtyMax = 0),
                  (this._totalMin = R.INT_MAX),
                  (this._totalMax = 0),
                  (this._byteCount = 0),
                  (this._context = t),
                  (this._byteCount = e),
              ...
              prepare() {
                ...
                this._generation !== this._context.generation &&
                  ...
                  (this._generation = this._context.generation),
                  (this._isDirty = !0)),
                  t.bindBuffer(t.ARRAY_BUFFER, this._buffer),
                  this._isDirty &&
                    (t.bufferData(t.ARRAY_BUFFER, this._byteCount, t.DYNAMIC_DRAW),
              ...
              static from(t) {
                return i(null == t || t instanceof R), t
              }
            }
      ...
      function (require, module, exports) {
        ...
        class a {
          ...
          renderViaAtlas(e, t) {
            ...
            return this.textureRenderer.render({texture: this.texture, srcRect: c, dstRect: t}), !0
          }
        }
        exports.RowAtlas = a
      },
    ...
    zEXv: [
      ...
      {'../lib/utils': 'ucYa', '../gl/row-atlas': 'cFC1', '../gl/canvas-context': 'KwET'},
    ],
    MwGB: [
      function (require, module, exports) {
        'use strict'
    ...
    QkVE: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.useAtom = i), (exports.Atom = void 0)
        var s = require('preact/hooks')
        let t = null,
          e = null
        class r {
          constructor(s, t) {
            ;(this.state = s), (this.observers = []), (this.set = this.set.bind(this)), (this.get = this.get.bind(this))
          }
          set(s) {
            this.state !== s && ((this.state = s), this.observers.forEach((s) => s()))
          }
          get() {
            return this.state
          }
          ...
          unsubscribe(s) {
            const t = this.observers.indexOf(s)
            ;-1 !== t && this.observers.splice(t, 1)
          }
        }
        function i(t) {
          const [e, r] = (0, s.useState)(t.get())
          return (
            (0, s.useLayoutEffect)(() => {
              function s() {
                r(t.get())
    ...
    O1pB: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.getHashParams = o)
        var e = require('../lib/view-mode')
        function r(r) {
          switch (r) {
            case 'time-ordered':
              return e.ViewMode.CHRONO_FLAME_CHART
            case 'left-heavy':
              return e.ViewMode.LEFT_HEAVY_FLAME_GRAPH
            case 'sandwich':
              return e.ViewMode.SANDWICH_VIEW
            default:
              return null
          }
        }
        function o(e = window.location.hash) {
          try {
            ...
            for (const e of t) {
              let [o, t] = e.split('=')
              if (((t = decodeURIComponent(t)), 'profileURL' === o)) i.profileURL = t
              else if ('title' === o) i.title = t
              else if ('localProfilePath' === o) i.localProfilePath = t
              else if ('view' === o) {
                const e = r(t)
                null !== e ? (i.viewMode = e) : console.error(`Ignoring invalid view specifier: ${t}`)
              }
            }
            return i
          } catch (o) {
            return console.error('Error when loading hash fragment.'), console.error(o), {}
          }
        }
      },
      {'../lib/view-mode': 'dpTI'},
    ...
    uxXA: [
      function (require, module, exports) {
        ...
        let i = {
          hover: null,
          selectedNode: null,
          configSpaceViewportRect: a.Rect.empty,
          logicalSpaceViewportSize: a.Vec2.zero,
        }
        class s extends t.Atom {
          constructor() {
            super(...arguments),
              (this.setProfileGroup = (e) => {
                this.set({
                  name: e.name,
                  indexToView: e.indexToView,
                  profiles: e.profiles.map((e) => ({
                    profile: e,
                    chronoViewState: i,
                    leftHeavyViewState: i,
                    sandwichViewState: {callerCallee: null},
                  })),
                })
              }),
              (this.setProfileIndexToView = (e) => {
                null != this.state &&
                  ((e = (0, a.clamp)(e, 0, this.state.profiles.length - 1)),
                  this.set(Object.assign(Object.assign({}, this.state), {indexToView: e})))
              }),
              (this.setSelectedFrame = (e) => {
                if (null == this.state) return
                null != this.getActiveProfile() &&
                  this.updateActiveSandwichViewState((t) =>
                    null == e
                      ? {callerCallee: null}
                      : {callerCallee: {invertedCallerFlamegraph: i, calleeFlamegraph: i, selectedFrame: e}},
                  )
              })
          }
          set(e) {
            const t = this.state
            ;(null != t && null != e && (0, l.objectsHaveShallowEquality)(t, e)) || super.set(e)
          }
          getActiveProfile() {
            var e
            return null == this.state
              ? null
              : this.state.profiles[null === (e = this.state) || void 0 === e ? void 0 : e.indexToView] || null
          }
          updateActiveProfileState(e) {
            if (null == this.state) return
            const {indexToView: t, profiles: a} = this.state
            this.set(Object.assign(Object.assign({}, this.state), {profiles: a.map((a, l) => (l != t ? a : e(a)))}))
          }
          updateActiveSandwichViewState(e) {
            this.updateActiveProfileState((t) =>
              Object.assign(Object.assign({}, t), {sandwichViewState: e(t.sandwichViewState)}),
            )
          }
          updateFlamechartState(t, a) {
            switch (t) {
              case e.CHRONO:
                this.updateActiveProfileState((e) =>
                  Object.assign(Object.assign({}, e), {chronoViewState: a(e.chronoViewState)}),
                )
                break
              case e.LEFT_HEAVY:
                this.updateActiveProfileState((e) =>
                  Object.assign(Object.assign({}, e), {leftHeavyViewState: a(e.leftHeavyViewState)}),
                )
                break
              case e.SANDWICH_CALLEES:
                this.updateActiveSandwichViewState((e) =>
                  Object.assign(Object.assign({}, e), {
                    callerCallee:
                      null == e.callerCallee
                        ? null
                        : Object.assign(Object.assign({}, e.callerCallee), {
                            calleeFlamegraph: a(e.callerCallee.calleeFlamegraph),
                          }),
                  }),
                )
                break
              case e.SANDWICH_INVERTED_CALLERS:
                this.updateActiveSandwichViewState((e) =>
                  Object.assign(Object.assign({}, e), {
                    callerCallee:
                      null == e.callerCallee
                        ? null
                        : Object.assign(Object.assign({}, e.callerCallee), {
                            invertedCallerFlamegraph: a(e.callerCallee.invertedCallerFlamegraph),
                          }),
                  }),
                )
            }
          }
          setFlamechartHoveredNode(e, t) {
            this.updateFlamechartState(e, (e) => Object.assign(Object.assign({}, e), {hover: t}))
          }
          setSelectedNode(e, t) {
            this.updateFlamechartState(e, (e) => Object.assign(Object.assign({}, e), {selectedNode: t}))
          }
          setConfigSpaceViewportRect(e, t) {
            this.updateFlamechartState(e, (e) => Object.assign(Object.assign({}, e), {configSpaceViewportRect: t}))
          }
          setLogicalSpaceViewportSize(e, t) {
            this.updateFlamechartState(e, (e) => Object.assign(Object.assign({}, e), {logicalSpaceViewportSize: t}))
          }
          clearHoverNode() {
            this.setFlamechartHoveredNode(e.CHRONO, null),
              this.setFlamechartHoveredNode(e.LEFT_HEAVY, null),
              this.setFlamechartHoveredNode(e.SANDWICH_CALLEES, null),
              this.setFlamechartHoveredNode(e.SANDWICH_INVERTED_CALLERS, null)
          }
        }
        exports.ProfileGroupAtom = s
      },
      {'../lib/atom': 'QkVE', '../lib/math': 'tDuZ', '../lib/utils': 'ucYa'},
    ],
    LDQe: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}),
          (exports.tableSortMethodAtom =
            exports.SortDirection =
            exports.SortField =
            exports.errorAtom =
            exports.loadingAtom =
            exports.canUseXHR =
            exports.dragActiveAtom =
            exports.glCanvasAtom =
            exports.hashParamsAtom =
            exports.profileGroupAtom =
            exports.viewModeAtom =
            exports.searchQueryAtom =
            exports.searchIsActiveAtom =
            exports.flattenRecursionAtom =
              void 0)
        var o = require('../lib/atom'),
          t = require('../lib/view-mode'),
          e = require('../lib/hash-params'),
          r = require('./profile-group')
        const s = new o.Atom(!1, 'flattenRecursion')
        exports.flattenRecursionAtom = s
        const n = new o.Atom(!1, 'searchIsActive')
        exports.searchIsActiveAtom = n
        const i = new o.Atom('', 'searchQueryAtom')
        exports.searchQueryAtom = i
        const A = new o.Atom(t.ViewMode.CHRONO_FLAME_CHART, 'viewMode')
        exports.viewModeAtom = A
        const a = new r.ProfileGroupAtom(null, 'profileGroup')
        ;(exports.profileGroupAtom = a),
          A.subscribe(() => {
            a.clearHoverNode()
          })
        const p = (0, e.getHashParams)(),
          c = new o.Atom(p, 'hashParams')
        exports.hashParamsAtom = c
        const m = new o.Atom(null, 'glCanvas')
        exports.glCanvasAtom = m
        const l = new o.Atom(!1, 'dragActive')
        exports.dragActiveAtom = l
        const x = window.location.protocol,
          d = 'http:' === x || 'https:' === x
        exports.canUseXHR = d
        const u = d && null != p.profileURL,
          h = new o.Atom(u, 'loading')
        exports.loadingAtom = h
        const S = new o.Atom(!1, 'error')
        var v, w
        ;(exports.errorAtom = S),
          (exports.SortField = v),
          (function (o) {
            ;(o[(o.SYMBOL_NAME = 0)] = 'SYMBOL_NAME'), (o[(o.SELF = 1)] = 'SELF'), (o[(o.TOTAL = 2)] = 'TOTAL')
          })(v || (exports.SortField = v = {})),
          (exports.SortDirection = w),
          (function (o) {
            ;(o[(o.ASCENDING = 0)] = 'ASCENDING'), (o[(o.DESCENDING = 1)] = 'DESCENDING')
          })(w || (exports.SortDirection = w = {}))
        const E = new o.Atom({field: v.SELF, direction: w.DESCENDING}, 'tableSortMethod')
        exports.tableSortMethodAtom = E
      },
      {'../lib/atom': 'QkVE', '../lib/view-mode': 'dpTI', '../lib/hash-params': 'O1pB', './profile-group': 'uxXA'},
    ],
    MY42: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.useActiveProfileState = t)
        var e = require('./getters'),
          i = require('.'),
          r = require('../lib/atom')
        function t() {
          const t = (0, r.useAtom)(i.flattenRecursionAtom),
            o = (0, r.useAtom)(i.profileGroupAtom)
          if (!o) return null
          if (o.indexToView >= o.profiles.length) return null
          const n = o.indexToView,
            s = o.profiles[n]
          return Object.assign(Object.assign({}, o.profiles[o.indexToView]), {
            profile: (0, e.getProfileToView)({profile: s.profile, flattenRecursion: t}),
            index: o.indexToView,
          })
        }
      },
      {'./getters': 'zEXv', '.': 'LDQe', '../lib/atom': 'QkVE'},
    ],
    KQrJ: [
      function (require, module, exports) {
        'use strict'
        ...
        var e,
          o = require('../lib/atom')
        ;(exports.ColorScheme = e),
          (function (e) {
            ;(e[(e.SYSTEM = 0)] = 'SYSTEM'), (e[(e.DARK = 1)] = 'DARK'), (e[(e.LIGHT = 2)] = 'LIGHT')
          })(e || (exports.ColorScheme = e = {}))
        const r = 'speedscope-color-scheme'
        function t() {
          const o = window.localStorage && window.localStorage[r]
          return 'DARK' === o ? e.DARK : 'LIGHT' === o ? e.LIGHT : e.SYSTEM
        }
        function c() {
        ...
        const n = new a(t(), 'colorScheme')
        ;(exports.colorSchemeAtom = n),
          n.subscribe(() => {
            const o = n.get()
            switch (o) {
              case e.DARK:
                window.localStorage[r] = 'DARK'
                break
              case e.LIGHT:
                window.localStorage[r] = 'LIGHT'
                break
              case e.SYSTEM:
                delete window.localStorage[r]
                break
              default:
                return o
            }
      ...
      function (require, module, exports) {
        ...
        const t = 0.2,
          ...
          A = `\n  vec3 colorForBucket(float t) {\n    float x = triangle(30.0 * t);\n    float H = 360.0 * (0.9 * t);\n    float C = ${(0.2).toFixed(
            1,
          )} + ${(0.1).toFixed(1)} * x;\n    float L = ${(0.2).toFixed(1)} - ${(0.1).toFixed(
            1,
      ...
      function (require, module, exports) {
        ...
        const t = 0.25,
          ...
          i = `\n  vec3 colorForBucket(float t) {\n    float x = triangle(30.0 * t);\n    float H = 360.0 * (0.9 * t);\n    float C = ${(0.25).toFixed(
            1,
          )} + ${(0.2).toFixed(1)} * x;\n    float L = ${(0.8).toFixed(1)} - ${(0.15).toFixed(
            1,
          )} * x;\n    return hcl2rgb(H, C, L);\n  }\n`,
          C = {
    ...
    gzKG: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', {value: !0}),
          (exports.useTheme = i),
          (exports.withTheme = u),
          (exports.colorSchemeToString = a),
          (exports.ThemeProvider = S),
          (exports.ThemeContext = void 0)
        var e = require('preact'),
          r = require('preact/hooks'),
          t = require('../../app-state/color-scheme'),
          o = require('../../lib/atom'),
          c = require('../../lib/utils'),
          n = require('./dark-theme'),
          h = require('./light-theme')
        const s = (0, e.createContext)(h.lightTheme)
        function i() {
          return (0, r.useContext)(s)
        }
        function u(e) {
          return (0, c.memoizeByReference)(e)
        }
        function m() {
          return matchMedia('(prefers-color-scheme: dark)')
        }
        function a(e) {
          switch (e) {
            case t.ColorScheme.SYSTEM:
              return 'System'
            case t.ColorScheme.DARK:
              return 'Dark'
            case t.ColorScheme.LIGHT:
              return 'Light'
          }
        }
        function l(e, r) {
          switch (e) {
            case t.ColorScheme.SYSTEM:
              return r ? n.darkTheme : h.lightTheme
            case t.ColorScheme.DARK:
              return n.darkTheme
            case t.ColorScheme.LIGHT:
              return h.lightTheme
        ...
        function S(c) {
          const [n, h] = (0, r.useState)(() => m().matches),
            i = (0, r.useCallback)(
              (e) => {
                h(e.matches)
              },
          ...
          const u = l((0, o.useAtom)(t.colorSchemeAtom), n)
          return (0, e.h)(s.Provider, {value: u, children: c.children})
        }
    ...
    FRuF: [
      function (require, module, exports) {
        ...
        var e = {'space-around': 'distribute', 'space-between': 'justify', 'flex-start': 'start', 'flex-end': 'end'},
          t = {
    ...
    bHSr: [
      function (require, module, exports) {
        ...
        var e = {
          ...
          t = {alignItems: 'WebkitBoxAlign', justifyContent: 'WebkitBoxPack', flexWrap: 'WebkitBoxLines'}
        function i(i, r, o) {
          'flexDirection' === i &&
            'string' == typeof r &&
    ...
    M0DH: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.default = i)
        var t = ['-webkit-', '-moz-', ''],
          e = {maxHeight: !0, maxWidth: !0, width: !0, height: !0, columnWidth: !0, minWidth: !0, minHeight: !0},
          n = {'min-content': !0, 'max-content': !0, 'fill-available': !0, 'fit-content': !0, 'contain-floats': !0}
        function i(i, o) {
            ...
            'undefined' != typeof window
              ...
              : {
                  renderStatic: (function () {
                    return function (e) {
                      return ne(), oe(), {html: e(), css: {content: se(), renderedClassNames: le()}}
                    }
                  })(),
                },
          Se = null
    ...
    hvr4: [
      function (require, module, exports) {
        ...
        const I = r.StyleSheet.create({
          fillY: {height: '100%'},
          fillX: {width: '100%'},
          hbox: {display: 'flex', flexDirection: 'row', position: 'relative', overflow: 'hidden'},
          vbox: {display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden'},
        })
      ...
      function (require, module, exports) {
        ...
        function s(e, t) {
          ...
          for (;;) {
            let e = s.indexOf(r, h)
            if (-1 === e) return a
            a.push([e, e + t.length]), (h = e + t.length)
          }
        }
            ...
            return (
              this.matches ||
                ...
                this.profile.forEachFrame((e) => {
                  const t = s(e.name, this.searchQuery)
                  this.matches.set(e, 0 === t.length ? null : t)
                })),
        ...
        class h {
          ...
          getResults() {
            if (null == this.matches) {
              const e = [],
                ...
                r = (h, a) => {
                  ...
                  if (this.profileResults.getMatchForFrame(c.frame)) {
                    const r = new t.Rect(new t.Vec2(h.start, a), new t.Vec2(h.end - h.start, 1))
                    s.set(c, e.length), e.push({configSpaceBounds: r, node: c})
                  }
              ...
              h.length > 0 && h[0].forEach((e) => r(e, 0)), (this.matches = {matches: e, indexForNode: s})
            }
            return this.matches
          }
          count() {
    ...
    t9CM: [
      function (require, module, exports) {
        ...
        var e = require('aphrodite'),
          ...
          i = require('../app-state/active-profile-state'),
          l = require('./themes/theme'),
          a = require('../app-state'),
          c = require('../lib/atom')
        function u(e) {
          e.stopPropagation()
        ...
        const p = ({children: e}) => {
          const o = (0, i.useActiveProfileState)(),
            n = o ? o.profile : null,
            l = (0, c.useAtom)(a.searchIsActiveAtom),
            u = (0, c.useAtom)(a.searchQueryAtom),
            p = (0, r.useMemo)(() => (n && l && 0 !== u.length ? new s.ProfileSearchResults(n, u) : null), [l, u, n])
          return (0, t.h)(h.Provider, {value: p}, e)
        }
        exports.ProfileSearchContextProvider = p
        const d = (0, o.memo)(({numResults: o, resultIndex: n, selectNext: s, selectPrev: i}) => {
          const h = (0, l.useTheme)(),
            p = m(h),
            d = (0, c.useAtom)(a.searchIsActiveAtom),
            f = (0, c.useAtom)(a.searchQueryAtom),
            y = a.searchQueryAtom.set,
            g = a.searchIsActiveAtom.set,
            x = (0, r.useCallback)(
              (e) => {
            ...
            S = (0, r.useCallback)(
              (e) => {
                e.stopPropagation(),
                  'Escape' === e.key && g(!1),
                  'Enter' === e.key && C(e),
                  'f' == e.key && (e.metaKey || e.ctrlKey) && (b.current && b.current.select(), e.preventDefault())
              },
              [g, C],
            )
          return (
            ...
            d
              ? (0, t.h)(
                  ...
                  (0, t.h)('span', {className: (0, e.css)(p.icon)}, '🔍'),
                  (0, t.h)(
                    'span',
                  ...
                  null != o &&
                    (0, t.h)(
                      t.Fragment,
                      null,
                      (0, t.h)('span', {className: (0, e.css)(p.resultCount)}, null == n ? '?' : n + 1, '/', o),
                      (0, t.h)('button', {className: (0, e.css)(p.icon, p.button), onClick: i}, '⬅️'),
                      (0, t.h)('button', {className: (0, e.css)(p.icon, p.button), onClick: s}, '➡️'),
                    ),
                  (0, t.h)(
                    'svg',
                    {
        ...
        exports.SearchView = d
        const m = (0, l.withTheme)((t) =>
          e.StyleSheet.create({
            searchView: {
              position: 'absolute',
              top: 0,
              ...
              width: 208,
              borderWidth: 2,
              borderColor: t.altFgPrimaryColor,
              borderStyle: 'solid',
              fontSize: n.FontSize.LABEL,
              boxSizing: 'border-box',
              background: t.altBgSecondaryColor,
              color: t.altFgPrimaryColor,
              display: 'flex',
              alignItems: 'center',
            },
            ...
            input: {
              ...
              '::selection': {color: t.altFgPrimaryColor, background: t.selectionPrimaryColor},
            },
            ...
            button: {display: 'inline', background: 'none', border: 'none', padding: 0, ':focus': {outline: 'none'}},
          }),
        )
      },
      {
        ...
        '../app-state/active-profile-state': 'MY42',
        './themes/theme': 'gzKG',
        '../app-state': 'LDQe',
        '../lib/atom': 'QkVE',
      },
    ...
    Pua8: [
      function (require, module, exports) {
        ...
        function o(r) {
          ...
          return (0, e.h)('span', {className: (0, t.css)(o.stackChit), style: {backgroundColor: r.color}})
        }
      ...
      {preact: 'aSor', aphrodite: 'CxN7', './style': 'hvr4', './themes/theme': 'gzKG'},
    ],
    SGwe: [
      function (require, module, exports) {
        'use strict'
        ...
        const r = ({items: r, axis: l, renderItems: n, className: i, initialIndexInView: s}) => {
          const [u, o] = (0, t.useState)(null),
            [c, a] = (0, t.useState)(0),
            d = (0, t.useRef)(null),
            f = 'x' === l ? 'width' : 'height',
            x = 'x' === l ? 'left' : 'top',
            b = 'x' === l ? 'scrollLeft' : 'scrollTop',
            h = s ? r.reduce((e, t, r) => (r < s ? e + t.size : e), 0) : 0,
            m = (0, t.useRef)(h),
            v = (0, t.useCallback)(
              (e) => {
                e
                  ? requestAnimationFrame(() => {
                      o(e.getBoundingClientRect()[f]),
                        null != m.current && (e.scrollTo({[x]: m.current}), (m.current = null))
                    })
                  : o(null),
                  (d.current = e)
              },
            ...
            g = (0, t.useMemo)(() => {
              ...
              let l = 0,
                ...
                i = 0
              for (; i < r.length; i++) {
                if (((n = l), (l += r[i].size) >= e)) break
              }
              const s = i
              for (; i < r.length; i++) {
                if ((l += r[i].size) >= t) break
              }
              return {firstVisibleIndex: s, lastVisibleIndex: Math.min(i, r.length - 1), invisiblePrefixSize: n}
            }, [u, c, r]),
            p = (0, t.useMemo)(() => r.reduce((e, t) => e + t.size, 0), [r]),
            w = (0, t.useCallback)(() => {
          ...
          const z = (0, t.useMemo)(() => (g ? n(g.firstVisibleIndex, g.lastVisibleIndex) : null), [n, g]),
            I = (0, t.useMemo)(
              () =>
                (0, e.h)(
                  'div',
                  ...
                  (0, e.h)(
                    'div',
                    {style: {transform: `translateY(${(null == g ? void 0 : g.invisiblePrefixSize) || 0}px)`}},
                    z,
                  ),
                ),
              [g, z, p],
            )
          return (0, e.h)('div', {className: i, ref: v, onScroll: w}, I)
        }
        exports.ScrollableListView = r
      },
    ...
    Ivh5: [
      function (require, module, exports) {
        ...
        var e = require('preact'),
          ...
          r = require('../lib/utils'),
          o = require('./style'),
          l = require('./color-chit'),
          i = require('./scrollable-list-view'),
          a = require('../app-state/getters'),
          s = require('preact/compat'),
          c = require('preact/hooks'),
          n = require('./sandwich-view'),
          h = require('../lib/color'),
          d = require('./themes/theme'),
          m = require('../app-state'),
          u = require('../lib/atom')
        function S(r) {
          const o = p((0, d.useTheme)())
          return (0, e.h)(
            'div',
            {className: (0, t.css)(o.hBarDisplay)},
            (0, e.h)('div', {className: (0, t.css)(o.hBarDisplayFilled), style: {width: `${r.perc}%`}}),
          )
        }
        function b(r) {
          const o = (0, d.useTheme)(),
            l = p(o),
            {activeDirection: i} = r,
            a = i === m.SortDirection.ASCENDING ? o.fgPrimaryColor : o.fgSecondaryColor,
          ...
          return (0, e.h)(
            'svg',
            {
              ...
              fill: 'none',
              xmlns: 'http://www.w3.org/2000/svg',
              className: (0, t.css)(l.sortIcon),
            },
            (0, e.h)('path', {d: 'M0 4L4 0L8 4H0Z', fill: a}),
            (0, e.h)('path', {d: 'M0 4L4 0L8 4H0Z', transform: 'translate(0 10) scale(1 -1)', fill: s}),
          )
        }
        function g(t, r, o) {
          const l = []
          let i = 0
          for (let a of r)
            l.push(t.slice(i, a[0])), l.push((0, e.h)('span', {className: o}, t.slice(a[0], a[1]))), (i = a[1])
          return l.push(t.slice(i)), (0, e.h)('span', null, l)
        }
        const C = ({
            frame: o,
            matchedRanges: i,
            ...
            const m = p((0, d.useTheme)()),
              u = o.getTotalWeight(),
              b = o.getSelfWeight(),
              C = (100 * u) / a.getTotalNonIdleWeight(),
              f = (100 * b) / a.getTotalNonIdleWeight(),
              w = o === c
            return (0, e.h)(
              'tr',
              {
                ...
                className: (0, t.css)(m.tableRow, s % 2 == 0 && m.tableRowEven, w && m.tableRowSelected),
              },
              (0, e.h)(
                'td',
                {className: (0, t.css)(m.numericCell)},
                a.formatValue(u),
                ' (',
                (0, r.formatPercent)(C),
                ')',
              ...
              (0, e.h)(
                'td',
                {title: o.file, className: (0, t.css)(m.textCell)},
                (0, e.h)(l.ColorChit, {color: h(o)}),
                i ? g(o.name, i, (0, t.css)(m.matched, w && m.matchedSelected)) : o.name,
              ),
            )
          },
          f = (0, s.memo)(
            ({
              ...
              const f = p((0, d.useTheme)()),
                w = (0, c.useCallback)(
                  (e, t) => {
                    if ((t.preventDefault(), l.field == e))
                      a({
                        field: e,
                        direction:
                          l.direction === m.SortDirection.ASCENDING
                            ? m.SortDirection.DESCENDING
                            : m.SortDirection.ASCENDING,
                      })
                    else
                      switch (e) {
                        case m.SortField.SYMBOL_NAME:
                          a({field: e, direction: m.SortDirection.ASCENDING})
                          break
                        case m.SortField.SELF:
                        case m.SortField.TOTAL:
                          a({field: e, direction: m.SortDirection.DESCENDING})
                      }
                  },
                  [l, a],
                ),
                F = (0, c.useContext)(n.SandwichViewContext),
                y = (0, c.useCallback)(
                  (o, l) => {
                    if (!F) return null
                    const i = []
                    for (let e = o; e <= l; e++) {
                      const t = F.rowList[e],
                        o = F.getSearchMatchForFrame(t)
                      i.push(
                        C({
                          frame: t,
                          matchedRanges: null == o ? null : o,
                          index: e,
                          profile: r,
                          selectedFrame: s,
                          setSelectedFrame: h,
                        ...
                        (g
                          ? i.push(
                              (0, e.h)(
                                ...
                                (0, e.h)(
                                  'td',
                                  {className: (0, t.css)(f.emptyState)},
                          ...
                          : i.push(
                              (0, e.h)(
                                'tr',
                                null,
                                (0, e.h)('td', {className: (0, t.css)(f.emptyState)}, 'No symbols found.'),
                              ),
                            )),
                      (0, e.h)('table', {className: (0, t.css)(f.tableView)}, i)
                    )
                  },
                  [F, r, s, h, u, g, S, f.emptyState, f.tableView],
                ),
                N = (0, c.useMemo)(() => (null == F ? [] : F.rowList.map((e) => ({size: o.Sizes.FRAME_HEIGHT}))), [F]),
                E = (0, c.useCallback)((e) => w(m.SortField.TOTAL, e), [w]),
                A = (0, c.useCallback)((e) => w(m.SortField.SELF, e), [w]),
                v = (0, c.useCallback)((e) => w(m.SortField.SYMBOL_NAME, e), [w])
              return (0, e.h)(
                'div',
                {className: (0, t.css)(o.commonStyle.vbox, f.profileTableView)},
                (0, e.h)(
                  'table',
                  {className: (0, t.css)(f.tableView)},
                  (0, e.h)(
                    'thead',
                    {className: (0, t.css)(f.tableHeader)},
                    (0, e.h)(
                      'tr',
                      null,
                      (0, e.h)(
                        'th',
                        {className: (0, t.css)(f.numericCell), onClick: E},
                        (0, e.h)(b, {activeDirection: l.field === m.SortField.TOTAL ? l.direction : null}),
                        'Total',
                      ),
                      (0, e.h)(
                        'th',
                        {className: (0, t.css)(f.numericCell), onClick: A},
                        (0, e.h)(b, {activeDirection: l.field === m.SortField.SELF ? l.direction : null}),
                        'Self',
                      ),
                      (0, e.h)(
                        'th',
                        {className: (0, t.css)(f.textCell), onClick: v},
                        (0, e.h)(b, {activeDirection: l.field === m.SortField.SYMBOL_NAME ? l.direction : null}),
                        'Symbol Name',
                      ),
                    ),
                  ),
                ),
                (0, e.h)(i.ScrollableListView, {
                  axis: 'y',
                  items: N,
                  className: (0, t.css)(f.scrollView),
                  renderItems: y,
                  initialIndexInView: null == s ? null : null == F ? void 0 : F.getIndexForFrame(s),
                }),
              )
            },
          )
        exports.ProfileTableView = f
        const p = (0, d.withTheme)((e) =>
            t.StyleSheet.create({
              profileTableView: {background: e.bgPrimaryColor, height: '100%'},
              scrollView: {
                overflowY: 'auto',
                overflowX: 'hidden',
                flexGrow: 1,
              ...
              tableView: {width: '100%', fontSize: o.FontSize.LABEL, background: e.bgPrimaryColor},
              tableHeader: {
              ...
              sortIcon: {position: 'relative', top: 1, marginRight: o.Sizes.FRAME_HEIGHT / 4},
              tableRow: {background: e.bgPrimaryColor, height: o.Sizes.FRAME_HEIGHT},
              tableRowEven: {background: e.bgSecondaryColor},
              tableRowSelected: {background: e.selectionPrimaryColor, color: e.altFgPrimaryColor},
              numericCell: {
                ...
                position: 'relative',
                textAlign: 'right',
                paddingRight: o.Sizes.FRAME_HEIGHT,
                width: 6 * o.Sizes.FRAME_HEIGHT,
                minWidth: 6 * o.Sizes.FRAME_HEIGHT,
              },
              textCell: {
                textOverflow: 'ellipsis',
                overflow: 'hidden',
              ...
              hBarDisplay: {
                position: 'absolute',
                background: h.Color.fromCSSHex(e.weightColor).withAlpha(0.2).toCSS(),
                bottom: 2,
                height: 2,
                width: `calc(100% - ${2 * o.Sizes.FRAME_HEIGHT}px)`,
                right: o.Sizes.FRAME_HEIGHT,
              },
              hBarDisplayFilled: {height: '100%', position: 'absolute', background: e.weightColor, right: 0},
          ...
          w = (0, s.memo)((t) => {
            const {activeProfileState: r} = t,
              {profile: o, sandwichViewState: l} = r
            if (!o) throw new Error('profile missing')
            const i = (0, u.useAtom)(m.tableSortMethodAtom),
              s = (0, d.useTheme)(),
              {callerCallee: n} = l,
              h = n ? n.selectedFrame : null,
              S = (0, a.getFrameToColorBucket)(o),
              b = (0, a.createGetCSSColorForFrame)({theme: s, frameToColorBucket: S}),
              g = (0, c.useCallback)((e) => {
                m.profileGroupAtom.setSelectedFrame(e)
              }, []),
              C = (0, u.useAtom)(m.searchIsActiveAtom),
              p = (0, u.useAtom)(m.searchQueryAtom)
            return (0, e.h)(f, {
              profile: o,
              selectedFrame: h,
              getCSSColorForFrame: b,
              sortMethod: i,
              setSelectedFrame: g,
              setSortMethod: m.tableSortMethodAtom.set,
              searchIsActive: C,
              searchQuery: p,
            })
          })
        exports.ProfileTableViewContainer = w
      },
      {
        preact: 'aSor',
        aphrodite: 'CxN7',
      ...
      function (require, module, exports) {
        ...
        class l {
          ...
          render(e) {
            ...
            let h = 0
            for (;;) {
              const e = a.getOrInsert(this.atlasKeys, {stackDepth: 0, zoomLevel: h, index: 0}),
            ...
            for (let t = l; t < g; t++)
              for (let e = u; e <= R; e++) {
                const n = this.options.inverted ? w - 1 - t : t,
                  s = a.getOrInsert(this.atlasKeys, {stackDepth: n, zoomLevel: h, index: e})
      ...
      function (require, module, exports) {
        ...
        const t = (0, r.withTheme)((r) =>
          e.StyleSheet.create({
            ...
            fill: {width: '100%', height: '100%', position: 'absolute', left: 0, top: 0},
            minimap: {
            ...
            statsTableCell: {position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center'},
            thisInstanceCell: {background: r.selectionPrimaryColor, color: r.altFgPrimaryColor},
            allInstancesCell: {background: r.selectionSecondaryColor, color: r.altFgPrimaryColor},
            barDisplay: {position: 'absolute', top: 0, left: 0, background: 'rgba(0, 0, 0, 0.2)', width: '100%'},
          }),
        )
    ...
    eeWS: [
      function (require, module, exports) {
        ...
        function s(e, n) {
          ...
          const i = n - r - 1,
            s = e.substring(0, r),
            h = e.substring(e.length - i, e.length),
            g = s + t + h
          return {
            trimmedString: g,
        ...
        function h(t, n, r) {
          ...
          const [h] = (0, e.findValueBisect)(0, n.length, (e) => i(t, s(n, Math.floor(e)).trimmedString), r)
          return s(n, Math.floor(h))
        }
        var g
        function a(e, t) {
        ...
        class c extends t.Component {
          ...
          render() {
            ...
            return (0, t.h)(
              ...
              (0, t.h)('canvas', {width: 1, height: 1, ref: this.overlayCanvasRef, className: (0, i.css)(e.fill)}),
            )
          }
        }
      ...
      function (require, module, exports) {
        ...
        function r(a) {
          ...
          return (0, l.h)(
            ...
            (0, l.h)('div', {className: (0, e.css)(a.cellStyle, r.statsTableCell, r.statsTableHeader)}, a.title),
            ...
            (0, l.h)(
              ...
              (0, s.formatPercent)(h),
              (0, l.h)('div', {className: (0, e.css)(r.barDisplay), style: {height: `${h}%`}}),
            ),
            (0, l.h)(
              'div',
              {className: (0, e.css)(a.cellStyle, r.statsTableCell)},
              (0, s.formatPercent)(n),
              (0, l.h)('div', {className: (0, e.css)(r.barDisplay), style: {height: `${n}%`}}),
            ),
          )
        }
        function i(s) {
        ...
        class h extends s.Component {
            ...
            super(...arguments),
              ...
              (this.onMouseMove = (t) => {
                ...
                const r = (t, i = 0) => {
                  ...
                  a.contains(s) && (this.hoveredLabel = {configSpaceBounds: a, node: t.node})
                ...
                this.hoveredLabel
                  ? this.props.onNodeHover({node: this.hoveredLabel.node, event: t})
                ...
                if (
                  ...
                  if (g.hasIntersectionWith(this.props.configSpaceViewportRect)) {
                    ...
                    if (
                      ...
                      if (s) {
                        const t = (0, i.remapRangesToTrimmedText)(n, s)
                        let h = 0,
                          c = e.left() + p
                        const l = (a - r) / 2 - 2
                        for (let [s, r] of t) {
          ...
          render() {
            ...
            return (0, s.h)(
              ...
              (0, s.h)('canvas', {width: 1, height: 1, ref: this.overlayCanvasRef, className: (0, r.css)(e.fill)}),
            )
          }
        }
    ...
    PGRN: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.Hovertip = n)
        var e = require('./style'),
          t = require('aphrodite'),
          i = require('preact'),
          ...
          r = require('preact/hooks')
        function n(e) {
          const n = a((0, o.useTheme)()),
            {containerSize: s, offset: d} = e,
            h = s.x,
            l = s.y,
            p = (0, r.useCallback)(
              (e) => {
                ...
                const t = e.getBoundingClientRect()
                let i = d.x + 7
                i + t.width > h - 1 && (i = h - t.width - 1) < 1 && (i = 1), (e.style.left = `${i}px`)
                let o = d.y + 7
                o + t.height > l - 1 && (o = d.y - t.height - 1) < 1 && (o = 1), (e.style.top = `${o}px`)
              },
              [h, l, d.x, d.y],
            )
          return (0, i.h)(
            'div',
            {className: (0, t.css)(n.hoverTip), ref: p},
            (0, i.h)('div', {className: (0, t.css)(n.hoverTipRow)}, e.children),
          )
        }
        const s = 2,
          a = (0, o.withTheme)((i) =>
      ...
      {'./style': 'hvr4', aphrodite: 'CxN7', preact: 'aSor', './themes/theme': 'gzKG', 'preact/hooks': 'MwGB'},
    ],
    zsRf: [
      function (require, module, exports) {
        'use strict'
        ...
        const a = (0, e.memo)(() => {
          const e = (0, t.useContext)(o),
            ...
            s = null == e ? null : e.configSpaceViewportRect,
            i = null == e ? null : e.setConfigSpaceViewportRect,
            ...
            f = (0, t.useCallback)(
              (e) => {
                ...
                const t = e.configSpaceBounds,
                  l = new c.Rect(t.origin.minus(new c.Vec2(0, 1)), t.size.withY(s.height()))
                a(e.node), i(p.getClampedConfigSpaceViewportRect({configSpaceViewportRect: l}))
              },
              [s, i, a, p],
            ),
          ...
          return (0, n.h)(l.SearchView, {resultIndex: d, numResults: h, selectPrev: x, selectNext: S})
        })
    ...
    Hete: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.StatelessComponent = void 0)
        var e = require('preact')
        class t extends e.Component {}
        exports.StatelessComponent = t
      },
      {preact: 'aSor'},
    ],
    Z2mP: [
      function (require, module, exports) {
        ...
        var e = require('preact'),
          ...
          p = require('./hovertip'),
          h = require('./search-view'),
          n = require('./flamechart-search-view'),
          l = require('./flamechart-style'),
          m = require('../lib/preact-helpers')
        class f extends m.StatelessComponent {
          constructor() {
            super(...arguments),
          ...
          getStyle() {
            return (0, l.getFlamechartStyle)(this.props.theme)
          }
          configSpaceSize() {
          ...
          renderTooltip() {
            ...
            return (0, e.h)(
              ...
              (0, e.h)('span', {className: (0, t.css)(l.hoverCount)}, this.formatValue(i.node.getTotalWeight())),
              ' ',
              n.name,
              n.file ? (0, e.h)('div', null, n.file, ':', n.line) : void 0,
            )
          }
          render() {
            ...
            return (0, e.h)(
              'div',
              {className: (0, t.css)(r.fill, s.commonStyle.vbox), ref: this.containerRef},
              ...
              (0, e.h)(h.ProfileSearchContext.Consumer, null, (t) =>
                (0, e.h)(
                  e.Fragment,
                  null,
                  ...
                  (0, e.h)(n.FlamechartSearchView, null),
                ),
              ),
              this.renderTooltip(),
    ...
    PJJu: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}),
          (exports.useFlamechartSetters = h),
          (exports.LeftHeavyFlamechartView =
            ...
            exports.getChronoViewFlamechart =
              void 0)
        var e = require('preact'),
          t = require('../lib/flamechart'),
          r = require('../gl/flamechart-renderer'),
          a = require('../lib/utils'),
          o = require('./flamechart-view'),
          c = require('../app-state/getters'),
          l = require('preact/compat'),
          i = require('./flamechart-search-view'),
          m = require('./themes/theme'),
          s = require('../app-state/profile-group'),
          n = require('../app-state')
        function h(e) {
          return {
            setNodeHover: (0, l.useCallback)(
              (t) => {
                n.profileGroupAtom.setFlamechartHoveredNode(e, t)
              },
              [e],
            ),
            setLogicalSpaceViewportSize: (0, l.useCallback)(
              (t) => {
                n.profileGroupAtom.setLogicalSpaceViewportSize(e, t)
              },
              [e],
            ),
            setConfigSpaceViewportRect: (0, l.useCallback)(
              (t) => {
                n.profileGroupAtom.setConfigSpaceViewportRect(e, t)
              },
              [e],
            ),
            setSelectedNode: (0, l.useCallback)(
              (t) => {
                n.profileGroupAtom.setSelectedNode(e, t)
              },
              [e],
            ),
          }
        }
        const p = (0, a.memoizeByShallowEquality)(
          ({profile: e, getColorBucketForFrame: r}) =>
            new t.Flamechart({
              getTotalWeight: e.getTotalWeight.bind(e),
              forEachCall: e.forEachCall.bind(e),
              formatValue: e.formatValue.bind(e),
              getColorBucketForFrame: r,
            }),
        )
        exports.getChronoViewFlamechart = p
        const f = (e) =>
          (0, a.memoizeByShallowEquality)(
            ({canvasContext: t, flamechart: a}) =>
              new r.FlamechartRenderer(
                t.gl,
                (0, c.getRowAtlas)(t),
                a,
        ...
        const C = f(),
          u = (0, l.memo)((t) => {
            const {activeProfileState: r, glCanvas: a} = t,
              {profile: l, chronoViewState: n} = r,
              f = (0, m.useTheme)(),
              u = (0, c.getCanvasContext)({theme: f, canvas: a}),
              d = (0, c.getFrameToColorBucket)(l),
              F = (0, c.createGetColorBucketForFrame)(d),
              g = (0, c.createGetCSSColorForFrame)({theme: f, frameToColorBucket: d}),
              S = p({profile: l, getColorBucketForFrame: F}),
              w = C({canvasContext: u, flamechart: S}),
              v = h(s.FlamechartID.CHRONO)
            return (0, e.h)(
              i.FlamechartSearchContextProvider,
              {
                flamechart: S,
                selectedNode: n.selectedNode,
                setSelectedNode: v.setSelectedNode,
                configSpaceViewportRect: n.configSpaceViewportRect,
                ...
                Object.assign(
                  {
                    ...
                    renderInverted: !1,
                    flamechart: S,
                    flamechartRenderer: w,
                    canvasContext: u,
                    getCSSColorForFrame: g,
                  },
                  n,
                  v,
                ),
        ...
        exports.ChronoFlamechartView = u
        const d = (0, a.memoizeByShallowEquality)(
          ({profile: e, getColorBucketForFrame: r}) =>
            new t.Flamechart({
        ...
        exports.getLeftHeavyFlamechart = d
        const F = f(),
          g = (0, l.memo)((t) => {
            const {activeProfileState: r, glCanvas: a} = t,
              {profile: l, leftHeavyViewState: n} = r,
              p = (0, m.useTheme)(),
              f = (0, c.getCanvasContext)({theme: p, canvas: a}),
              C = (0, c.getFrameToColorBucket)(l),
              u = (0, c.createGetColorBucketForFrame)(C),
              g = (0, c.createGetCSSColorForFrame)({theme: p, frameToColorBucket: C}),
              S = d({profile: l, getColorBucketForFrame: u}),
              w = F({canvasContext: f, flamechart: S}),
              v = h(s.FlamechartID.LEFT_HEAVY)
            return (0, e.h)(
              i.FlamechartSearchContextProvider,
              {
                flamechart: S,
        ...
        exports.LeftHeavyFlamechartView = g
      },
      {
        preact: 'aSor',
        '../lib/flamechart': 'gFMr',
    ...
    MXNL: [
      function (require, module, exports) {
        ...
        var e = require('aphrodite'),
          ...
          n = require('../lib/preact-helpers')
        class c extends n.StatelessComponent {
          constructor() {
            super(...arguments),
              (this.setConfigSpaceViewportRect = (e) => {
          ...
          clampViewportToFlamegraph(e) {
            ...
            return t.getClampedConfigSpaceViewportRect({configSpaceViewportRect: e, renderInverted: r})
          }
          formatValue(e) {
            const t = (100 * e) / this.props.flamechart.getTotalWeight(),
          ...
          renderTooltip() {
            ...
            return (0, t.h)(
              ...
              ' ',
              m.name,
              m.file ? (0, t.h)('div', null, m.file, ':', m.line) : void 0,
            )
          }
          render() {
            return (0, t.h)(
        ...
        const l = (0, a.withTheme)((t) => e.StyleSheet.create({hoverCount: {color: t.weightColor}}))
        exports.getStyle = l
      },
      {
        aphrodite: 'CxN7',
    ...
    Cw7z: [
      function (require, module, exports) {
        ...
        var e = require('../lib/utils'),
          ...
          l = require('preact'),
          i = require('preact/compat'),
          n = require('./themes/theme'),
          m = require('../app-state/profile-group'),
          c = require('../app-state'),
          s = require('../lib/atom')
        const u = (0, e.memoizeByShallowEquality)(({profile: e, frame: r, flattenRecursion: t}) => {
            let a = e.getInvertedProfileForCallersOf(r)
            return t ? a.getProfileWithRecursionFlattened() : a
          }),
          h = (0, e.memoizeByShallowEquality)(
          ...
          f = (0, t.createMemoizedFlamechartRenderer)({inverted: !0}),
          p = (0, i.memo)((r) => {
            const {activeProfileState: i} = r
            let {profile: p, sandwichViewState: C} = i
            const d = (0, s.useAtom)(c.flattenRecursionAtom),
              F = (0, s.useAtom)(c.glCanvasAtom),
              g = (0, n.useTheme)()
            ...
            const {selectedFrame: w} = v,
              q = (0, a.getFrameToColorBucket)(p),
              S = (0, a.createGetColorBucketForFrame)(q),
              E = (0, a.createGetCSSColorForFrame)({theme: g, frameToColorBucket: q}),
              b = (0, a.getCanvasContext)({theme: g, canvas: F}),
              B = h({invertedCallerProfile: u({profile: p, frame: w, flattenRecursion: d}), getColorBucketForFrame: S}),
              I = f({canvasContext: b, flamechart: B})
            return (0, l.h)(
              o.FlamechartWrapper,
              Object.assign(
                {
                  ...
                  renderInverted: !0,
                  flamechart: B,
                  flamechartRenderer: I,
                  canvasContext: b,
                  getCSSColorForFrame: E,
                },
                (0, t.useFlamechartSetters)(m.FlamechartID.SANDWICH_INVERTED_CALLERS),
                v.invertedCallerFlamegraph,
                {setSelectedNode: e.noop},
              ),
            )
          })
        exports.InvertedCallerFlamegraphView = p
      },
      {
        '../lib/utils': 'ucYa',
        '../lib/flamechart': 'gFMr',
    ...
    KT37: [
      function (require, module, exports) {
        ...
        const u = (0, e.memoizeByShallowEquality)(({profile: e, frame: r, flattenRecursion: t}) => {
          ...
          f = (0, t.createMemoizedFlamechartRenderer)(),
          p = (0, i.memo)((r) => {
            const {activeProfileState: i} = r,
              {profile: p, sandwichViewState: C} = i,
              F = (0, s.useAtom)(n.flattenRecursionAtom),
              g = (0, s.useAtom)(n.glCanvasAtom),
              d = (0, c.useTheme)()
            if (!p) throw new Error('profile missing')
            if (!g) throw new Error('glCanvas missing')
            const {callerCallee: w} = C
            if (!w) throw new Error('callerCallee missing')
            const {selectedFrame: q} = w,
              v = (0, a.getFrameToColorBucket)(p),
              S = (0, a.createGetColorBucketForFrame)(v),
              E = (0, a.createGetCSSColorForFrame)({theme: d, frameToColorBucket: v}),
              b = (0, a.getCanvasContext)({theme: d, canvas: g}),
              B = h({calleeProfile: u({profile: p, frame: q, flattenRecursion: F}), getColorBucketForFrame: S}),
              k = f({canvasContext: b, flamechart: B})
            return (0, l.h)(
              o.FlamechartWrapper,
              Object.assign(
                {
                  ...
                  renderInverted: !1,
                  flamechart: B,
                  flamechartRenderer: k,
                  canvasContext: b,
                  getCSSColorForFrame: E,
                },
                (0, t.useFlamechartSetters)(m.FlamechartID.SANDWICH_CALLEES),
                w.calleeFlamegraph,
                {setSelectedNode: e.noop},
              ),
            )
          })
        exports.CalleeFlamegraphView = p
      },
      {
        '../lib/utils': 'ucYa',
        '../lib/flamechart': 'gFMr',
    ...
    cWm7: [
      function (require, module, exports) {
        ...
        const c = (0, e.memo)(() => {
          ...
          return (0, r.h)(t.SearchView, {resultIndex: n, numResults: u, selectPrev: i, selectNext: a})
        })
    ...
    L8J2: [
      function (require, module, exports) {
        ...
        var e = require('aphrodite'),
          ...
          l = require('preact/hooks'),
          o = require('./style'),
          s = require('./inverted-caller-flamegraph-view'),
          i = require('./callee-flamegraph-view'),
          n = require('./sandwich-search-view'),
          c = require('../lib/utils'),
          h = require('./search-view'),
          m = require('./themes/theme'),
          d = require('../app-state'),
          p = require('../lib/atom'),
          f = require('../lib/preact-helpers')
        class u extends f.StatelessComponent {
          constructor() {
            super(...arguments),
              (this.setSelectedFrame = (e) => {
          ...
          render() {
            ...
            return (
              l &&
                (c = (0, r.h)(
                  'div',
                  {className: (0, e.css)(o.commonStyle.fillY, a.callersAndCallees, o.commonStyle.vbox)},
                  (0, r.h)(
                    'div',
                    {className: (0, e.css)(o.commonStyle.hbox, a.panZoomViewWraper)},
                    (0, r.h)(
                      'div',
                      {className: (0, e.css)(a.flamechartLabelParent)},
                      (0, r.h)('div', {className: (0, e.css)(a.flamechartLabel)}, 'Callers'),
                    ),
                    (0, r.h)(s.InvertedCallerFlamegraphView, {
                  ...
                  (0, r.h)(
                    ...
                    (0, r.h)(
                      ...
                      (0, r.h)('div', {className: (0, e.css)(a.flamechartLabel, a.flamechartLabelBottom)}, 'Callees'),
                    ),
                    (0, r.h)(i.CalleeFlamegraphView, {
                      glCanvas: this.props.glCanvas,
                      activeProfileState: this.props.activeProfileState,
                    }),
                  ),
              ...
              (0, r.h)(
                'div',
                {className: (0, e.css)(o.commonStyle.hbox, o.commonStyle.fillY)},
                (0, r.h)(
                  'div',
                  {className: (0, e.css)(a.tableView)},
                  (0, r.h)(t.ProfileTableViewContainer, {activeProfileState: this.props.activeProfileState}),
                  (0, r.h)(n.SandwichSearchView, null),
                ),
                c,
              )
            )
        ...
        const S = (0, m.withTheme)((t) =>
            e.StyleSheet.create({
              ...
              flamechartLabelParent: {
                ...
                fontSize: o.FontSize.TITLE,
                width: 1.2 * o.FontSize.TITLE,
              ...
              flamechartLabelBottom: {transform: 'rotate(-90deg)', display: 'flex', justifyContent: 'flex-end'},
              callersAndCallees: {flex: 1, borderLeft: `${o.Sizes.SEPARATOR_HEIGHT}px solid ${t.fgSecondaryColor}`},
              divider: {height: 2, background: t.fgSecondaryColor},
            }),
          ),
          v = (0, r.createContext)(null)
        exports.SandwichViewContext = v
        const w = (0, a.memo)((e) => {
          const {activeProfileState: t, glCanvas: a} = e,
            {sandwichViewState: o, index: s} = t,
            {callerCallee: i} = o,
            n = (0, m.useTheme)(),
            f = (0, l.useCallback)((e) => {
              d.profileGroupAtom.setSelectedFrame(e)
            }, []),
            S = t.profile,
            w = (0, p.useAtom)(d.tableSortMethodAtom),
            x = (0, l.useContext)(h.ProfileSearchContext),
            C = i ? i.selectedFrame : null,
            g = (0, l.useMemo)(() => {
              const e = []
              switch (
                (S.forEachFrame((t) => {
                  ;(x && !x.getMatchForFrame(t)) || e.push(t)
                }),
                w.field)
              ) {
                case d.SortField.SYMBOL_NAME:
                  ;(0, c.sortBy)(e, (e) => e.name.toLowerCase())
                  break
                case d.SortField.SELF:
                  ;(0, c.sortBy)(e, (e) => e.getSelfWeight())
                  break
                case d.SortField.TOTAL:
                  ;(0, c.sortBy)(e, (e) => e.getTotalWeight())
              }
              return w.direction === d.SortDirection.DESCENDING && e.reverse(), e
            }, [S, x, w]),
            b = (0, l.useMemo)(() => {
              const e = new Map()
              for (let t = 0; t < g.length; t++) e.set(g[t], t)
              return (t) => {
                const r = e.get(t)
                return null == r ? null : r
              }
            }, [g]),
            F = (0, l.useMemo)(() => (e) => null == x ? null : x.getMatchForFrame(e), [x]),
            y = {rowList: g, selectedFrame: C, setSelectedFrame: f, getIndexForFrame: b, getSearchMatchForFrame: F}
          return (0, r.h)(
            v.Provider,
            {value: y},
            (0, r.h)(u, {
              theme: n,
              activeProfileState: t,
              glCanvas: a,
              setSelectedFrame: f,
              selectedFrame: C,
              profileIndex: s,
        ...
        exports.SandwichViewContainer = w
      },
      {
        aphrodite: 'CxN7',
    ...
    YG8z: [
      function (require, module, exports) {
        ...
        class i extends a {
          ...
          static getOrInsert(e, t) {
            return e.getOrInsert(new i(t))
          }
        }
        ;(exports.Frame = i), (i.root = new i({key: '(speedscope root)', name: '(speedscope root)'}))
        class l extends a {
          isRoot() {
        ...
        class n extends o {
          ...
          _appendSample(t, r, s) {
            ...
            let a = s ? this.appendOrderCalltreeRoot : this.groupedCalltreeRoot,
              i = new Set()
            for (let o of t) {
              const t = s ? (0, e.lastOf)(a.children) : a.children.find((e) => e.frame === o)
              if (t && !t.isFrozen() && t.frame == o) a = t
              else {
                const e = a
                ;(a = new l(o, a)), e.children.push(a)
              }
              a.addToTotalWeight(r), i.add(a.frame)
            }
          ...
          appendSampleWithWeight(e, t) {
            ...
            const r = e.map((e) => i.getOrInsert(this.frames, e))
            this._appendSample(r, t, !0), this._appendSample(r, t, !1)
          }
          appendSampleWithTimestamp(e, t) {
            if (this.pendingSample) {
              ...
              this.appendSampleWithWeight(this.pendingSample.stack, r - this.pendingSample.startTimestamp),
                (this.pendingSample = {stack: e, startTimestamp: r, centralTimestamp: t})
            } else this.pendingSample = {stack: e, startTimestamp: t, centralTimestamp: t}
          }
          build() {
            return (
              this.pendingSample &&
          ...
          _leaveFrame(e, t, r) {
            ...
            if ((this.addWeightsToNodes(t, s), r)) {
              ...
              if ((r.freeze(), r.frame.key !== e.key))
                throw new Error(`Tried to leave frame "${e.name}" while frame "${r.frame.name}" was at the top at ${t}`)
              const s = t - this.lastValue
    ...
    Xzb6: [
      function (require, module, exports) {
        ...
        function o(e, t) {
          ...
          return (
            e.forEachCall(
              (e, o) => {
                r.events.push({type: n.FileFormat.EventType.OPEN_FRAME, frame: t(e.frame), at: o})
              },
              (e, o) => {
                r.events.push({type: n.FileFormat.EventType.CLOSE_FRAME, frame: t(e.frame), at: o})
              },
            ),
            r
          )
      ...
      {'./profile': 'YG8z', './value-formatters': 'LsM4', './file-format-spec': 'x8nU', '../../package.json': 'EHrm'},
    ],
    C6HJ: [
      function (require, module, exports) {
        'use strict'
      ...
      function (require, module, exports) {
        ...
        function a({
          ...
          return (0, e.h)(
            ...
            (0, e.h)(
              'span',
              {className: (0, r.css)(b.profileIndex, a && b.profileIndexSelected), style: {width: w + 'em'}},
              h + 1,
              ':',
            ),
            ' ',
        ...
        function u({profiles: l, closeProfileSelect: t, indexToView: i, visible: s, setProfileIndexToView: u}) {
          ...
          ;(0, o.useEffect)(() => {
            s &&
              (P(null),
              null !== w.current && w.current.scrollIntoView({behavior: 'auto', block: 'nearest', inline: 'nearest'}))
          }, [s])
          ...
          const C = (0, o.useCallback)(
              (e) => {
                S && e && (e.scrollIntoView({behavior: 'auto', block: 'nearest', inline: 'nearest'}), v(!1))
              },
              [S, v],
            ),
            k = (0, o.useCallback)(
        ...
        const p = 10,
          f = (0, n.withTheme)((e) =>
            r.StyleSheet.create({
              filterInputContainer: {display: 'flex', flexDirection: 'column', padding: 5, alignItems: 'stretch'},
              filterInput: {
                ...
                padding: 5,
                ':focus': {border: 'none', outline: 'none'},
                '::selection': {color: e.altFgPrimaryColor, background: e.selectionPrimaryColor},
              },
              caret: {
                width: 0,
                height: 0,
              ...
              profileRowHovered: {border: `1px solid ${e.selectionPrimaryColor}`},
              ...
              profileIndex: {textAlign: 'right', display: 'inline-block', color: e.altFgSecondaryColor},
    ...
    BPHY: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.Toolbar = T)
        var e = require('preact'),
          o = require('preact/hooks'),
          t = require('aphrodite'),
          i = require('./style'),
          s = require('./profile-select'),
          l = require('../lib/utils'),
          a = require('./themes/theme'),
          r = require('../lib/view-mode'),
          n = require('../app-state'),
          c = require('../app-state/color-scheme'),
          h = require('../lib/atom')
        function d(e, t) {
          return (0, o.useCallback)(() => e(t), [e, t])
        }
        function m(o) {
          const i = g((0, a.useTheme)()),
            s = d(n.viewModeAtom.set, r.ViewMode.CHRONO_FLAME_CHART),
            l = d(n.viewModeAtom.set, r.ViewMode.LEFT_HEAVY_FLAME_GRAPH),
            c = d(n.viewModeAtom.set, r.ViewMode.SANDWICH_VIEW)
          return o.activeProfileState
            ? (0, e.h)(
                'div',
                {className: (0, t.css)(i.toolbarLeft)},
                (0, e.h)(
                  'div',
                  {
                    className: (0, t.css)(
                      i.toolbarTab,
                      o.viewMode === r.ViewMode.CHRONO_FLAME_CHART && i.toolbarTabActive,
                    ),
                    onClick: s,
                  },
                  (0, e.h)('span', {className: (0, t.css)(i.emoji)}, '🕰'),
                  'Time Order',
                ),
                (0, e.h)(
                  'div',
                  {
                    className: (0, t.css)(
                      i.toolbarTab,
                      o.viewMode === r.ViewMode.LEFT_HEAVY_FLAME_GRAPH && i.toolbarTabActive,
                    ),
                    onClick: l,
                  },
                  (0, e.h)('span', {className: (0, t.css)(i.emoji)}, '⬅️'),
                  'Left Heavy',
                ),
                (0, e.h)(
                  'div',
                  {
                    className: (0, t.css)(i.toolbarTab, o.viewMode === r.ViewMode.SANDWICH_VIEW && i.toolbarTabActive),
                    onClick: c,
                  },
                  (0, e.h)('span', {className: (0, t.css)(i.emoji)}, '🥪'),
                  'Sandwich',
        ...
        const b = (() => {
          ...
          return (o) => {
            ...
            return (null === e || (null != t && !(0, l.objectsHaveShallowEquality)(e, t))) && (e = t), e
          }
        })()
        function u(i) {
          const l = g((0, a.useTheme)()),
            {activeProfileState: r, profileGroup: n} = i,
            c = b(n),
            [h, d] = (0, o.useState)(!1),
            m = (0, o.useCallback)(() => {
              d(!0)
          ...
          return (
            ...
            r && n && c
              ? 1 === n.profiles.length
                ? (0, e.h)(e.Fragment, null, r.profile.getName())
                : (0, e.h)(
                    'div',
                    {className: (0, t.css)(l.toolbarCenter), onMouseLeave: u},
                    (0, e.h)(
                      'span',
                      {onMouseOver: m},
                      r.profile.getName(),
                      ...
                      (0, e.h)(
                        'span',
                        {className: (0, t.css)(l.toolbarProfileIndex)},
                        '(',
                        r.index + 1,
                        '/',
                        n.profiles.length,
                    ...
                    (0, e.h)(
                      ...
                      (0, e.h)(s.ProfileSelect, {
                        setProfileIndexToView: i.setProfileIndexToView,
                        indexToView: n.indexToView,
                        profiles: c,
                        closeProfileSelect: u,
                        visible: h,
                      }),
                    ),
                  )
              : (0, e.h)(e.Fragment, null, '🔬speedscope')
          )
        }
        function p(o) {
          const i = g((0, a.useTheme)()),
            s = (0, h.useAtom)(c.colorSchemeAtom),
            l = (0, e.h)(
              'div',
              {className: (0, t.css)(i.toolbarTab), onClick: o.saveFile},
              (0, e.h)('span', {className: (0, t.css)(i.emoji)}, '⤴️'),
              'Export',
            ),
            r = (0, e.h)(
              'div',
              {className: (0, t.css)(i.toolbarTab), onClick: o.browseForFile},
              (0, e.h)('span', {className: (0, t.css)(i.emoji)}, '⤵️'),
              'Import',
            ),
            n = (0, e.h)(
              'div',
              {className: (0, t.css)(i.toolbarTab), onClick: c.colorSchemeAtom.cycleToNextColorScheme},
              (0, e.h)('span', {className: (0, t.css)(i.emoji)}, '🎨'),
              (0, e.h)('span', {className: (0, t.css)(i.toolbarTabColorSchemeToggle)}, (0, a.colorSchemeToString)(s)),
            ),
            d = (0, e.h)(
              'div',
              {className: (0, t.css)(i.toolbarTab)},
              (0, e.h)(
                'a',
                {
                  href: 'https://github.com/jlfwong/speedscope#usage',
                  className: (0, t.css)(i.noLinkStyle),
                  target: '_blank',
                },
                (0, e.h)('span', {className: (0, t.css)(i.emoji)}, '❓'),
                'Help',
          ...
          return (0, e.h)('div', {className: (0, t.css)(i.toolbarRight)}, o.activeProfileState && l, r, n, d)
        }
        function T(o) {
          const i = g((0, a.useTheme)())
          return (0, e.h)(
            'div',
            {className: (0, t.css)(i.toolbar)},
            (0, e.h)(m, Object.assign({}, o)),
            (0, e.h)(u, Object.assign({}, o)),
            (0, e.h)(p, Object.assign({}, o)),
          )
        }
        const g = (0, a.withTheme)((e) =>
          t.StyleSheet.create({
            toolbar: {
              height: i.Sizes.TOOLBAR_HEIGHT,
              flexShrink: 0,
              background: e.altBgPrimaryColor,
              color: e.altFgPrimaryColor,
              textAlign: 'center',
              fontFamily: i.FontFamily.MONOSPACE,
              fontSize: i.FontSize.TITLE,
              lineHeight: `${i.Sizes.TOOLBAR_TAB_HEIGHT}px`,
              userSelect: 'none',
            },
            toolbarLeft: {
              position: 'absolute',
            ...
            toolbarCenter: {paddingTop: 1, height: i.Sizes.TOOLBAR_HEIGHT},
            toolbarRight: {
              height: i.Sizes.TOOLBAR_HEIGHT,
              overflow: 'hidden',
              position: 'absolute',
            ...
            toolbarTab: {
              background: e.altBgSecondaryColor,
              marginTop: i.Sizes.SEPARATOR_HEIGHT,
              height: i.Sizes.TOOLBAR_TAB_HEIGHT,
              lineHeight: `${i.Sizes.TOOLBAR_TAB_HEIGHT}px`,
              paddingLeft: 2,
              paddingRight: 8,
              display: 'inline-block',
              marginLeft: 2,
              transition: `all ${i.Duration.HOVER_CHANGE} ease-in`,
              ':hover': {background: e.selectionSecondaryColor},
            },
            toolbarTabActive: {background: e.selectionPrimaryColor, ':hover': {background: e.selectionPrimaryColor}},
            toolbarTabColorSchemeToggle: {display: 'inline-block', textAlign: 'center', minWidth: '50px'},
            emoji: {display: 'inline-block', verticalAlign: 'middle', paddingTop: '0px', marginRight: '0.3em'},
    ...
    bv0g: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', {value: !0}), (exports.importJavaScriptSourceMapSymbolRemapper = r)
        var e = require('./utils'),
          n = function (e, n, o, l) {
    ...
    wCGh: [
      function (require, module, exports) {
        ...
        var e = require('preact'),
          ...
          n = require('./flamechart-view-container'),
          a = require('./toolbar'),
          l = require('../lib/js-source-map'),
          c = require('./themes/theme'),
          p = require('../lib/view-mode'),
          d = require('../app-state'),
          h = require('../lib/preact-helpers'),
          u = function (e, t, o, i) {
        ...
        const m = require('_bundle_loader')(require.resolve('../import'))
        function f(e, t) {
          return u(this, void 0, void 0, function* () {
            return (yield m).importProfileGroupFromText(e, t)
          })
        }
        function v(e, t) {
          return u(this, void 0, void 0, function* () {
            return (yield m).importProfileGroupFromBase64(e, t)
          })
        }
        function g(e, t) {
          return u(this, void 0, void 0, function* () {
            return (yield m).importProfilesFromArrayBuffer(e, t)
          })
        }
        function w(e) {
          return u(this, void 0, void 0, function* () {
            return (yield m).importProfilesFromFile(e)
          })
        }
        function y(e) {
          return u(this, void 0, void 0, function* () {
            return (yield m).importFromFileSystemDirectoryEntry(e)
          })
        }
        m.then(() => {}),
          require('_bundle_loader')(require.resolve('../lib/demangle-cpp')).then(() => {}),
          require('_bundle_loader')(require.resolve('source-map')).then(() => {})
        const b = require('../../sample/profiles/stackcollapse/perf-vertx-stacks-01-collapsed-all.txt')
        function x(e) {
          return null != e && e.isDirectory
        }
        class C extends h.StatelessComponent {
          constructor() {
            super(...arguments),
              (this.canvas = null),
              (this.ref = (e) => {
        ...
        exports.GLCanvas = C
        class P extends h.StatelessComponent {
          constructor() {
            super(...arguments),
              (this.loadExample = () => {
                this.loadProfile(() =>
                  u(this, void 0, void 0, function* () {
                    const e = yield fetch(b).then((e) => e.text())
              ...
              (this.onDrop = (e) => {
                ...
                if ('webkitGetAsEntry' in t) {
                  ...
                  if (e && x(e) && e.name.endsWith('.trace')) {
                    console.log('Importing as Instruments.app .trace file')
                    const t = e
                    return void this.loadProfile(() =>
                      u(this, void 0, void 0, function* () {
                        return yield y(t)
                      }),
                    )
              ...
              (this.onWindowKeyPress = (e) =>
                u(this, void 0, void 0, function* () {
                  if ('1' === e.key) this.props.setViewMode(p.ViewMode.CHRONO_FLAME_CHART)
                  else if ('2' === e.key) this.props.setViewMode(p.ViewMode.LEFT_HEAVY_FLAME_GRAPH)
                  else if ('3' === e.key) this.props.setViewMode(p.ViewMode.SANDWICH_VIEW)
                  else if ('r' === e.key) {
              ...
              (this.saveFile = () => {
                if (this.props.profileGroup) {
                  const {name: e, indexToView: t, profiles: o} = this.props.profileGroup,
                    i = {name: e, indexToView: t, profiles: o.map((e) => e.profile)}
                  ;(0, s.saveToFile)(i)
                }
              }),
              (this.browseForFile = () => {
              ...
              (this.onDocumentPaste = (e) => {
                if (null != document.activeElement && 'INPUT' === document.activeElement.nodeName) return
          ...
          loadProfile(e) {
            return u(this, void 0, void 0, function* () {
              ...
              this.props.hashParams.title &&
                (t = Object.assign(Object.assign({}, t), {name: this.props.hashParams.title})),
                (document.title = `${t.name} - speedscope`),
                this.props.hashParams.viewMode && this.props.setViewMode(this.props.hashParams.viewMode)
            ...
            this.loadProfile(() =>
              u(this, void 0, void 0, function* () {
                ...
                if (this.props.profileGroup && this.props.activeProfileState) {
                  ...
                  const a = yield (0, l.importJavaScriptSourceMapSymbolRemapper)(r, e.name)
          ...
          maybeLoadHashParamProfile() {
            return u(this, void 0, void 0, function* () {
              const {profileURL: e} = this.props.hashParams
              if (e) {
                if (!d.canUseXHR)
                  return void alert(
                ...
                this.loadProfile(() =>
                  u(this, void 0, void 0, function* () {
                    ...
                    let o = new URL(e, window.location.href).pathname
                    return o.includes('/') && (o = o.slice(o.lastIndexOf('/') + 1)), yield g(o, yield t.arrayBuffer())
                  }),
                )
              } else if (this.props.hashParams.localProfilePath) {
                window.speedscope = {
                  loadFileFromBase64: (e, t) => {
                    this.loadProfile(() => v(e, t))
                  },
                }
              ...
              (0, e.h)(
                ...
                d.canUseXHR
                  ? (0, e.h)(
                      ...
                      (0, e.h)(
                        'a',
                        {tabIndex: 0, className: (0, t.css)(o.link), onClick: this.loadExample},
                        'click here',
                      ),
                      ' ',
                ...
                (0, e.h)(
                  ...
                  (0, e.h)('label', {for: 'file', className: (0, t.css)(o.browseButton), tabIndex: 0}, 'Browse'),
                ),
                (0, e.h)(
                  'p',
                  {className: (0, t.css)(o.landingP)},
          ...
          renderContent() {
            ...
            switch (t) {
              case p.ViewMode.CHRONO_FLAME_CHART:
                return (0, e.h)(n.ChronoFlamechartView, {activeProfileState: o, glCanvas: a})
              case p.ViewMode.LEFT_HEAVY_FLAME_GRAPH:
                return (0, e.h)(n.LeftHeavyFlamechartView, {activeProfileState: o, glCanvas: a})
              case p.ViewMode.SANDWICH_VIEW:
                return (0, e.h)(r.SandwichViewContainer, {activeProfileState: o, glCanvas: a})
            }
          }
          render() {
            const o = this.getStyle()
            return (0, e.h)(
              ...
              (0, e.h)(
                a.Toolbar,
                Object.assign({saveFile: this.saveFile, browseForFile: this.browseForFile}, this.props),
              ),
        ...
        exports.Application = P
        const F = (0, c.withTheme)((e) =>
          t.StyleSheet.create({
            glCanvasView: {position: 'absolute', width: '100vw', height: '100vh', zIndex: -1, pointerEvents: 'none'},
            error: {
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'center',
            ...
            landingContainer: {display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1},
            landingMessage: {maxWidth: 600},
            landingP: {marginBottom: 16},
            hide: {display: 'none'},
            browseButtonContainer: {display: 'flex', alignItems: 'center', justifyContent: 'center'},
            browseButton: {
              marginBottom: 16,
              height: 72,
              flex: 1,
      ...
      },
      {
        ...
        '../lib/preact-helpers': 'Hete',
        _bundle_loader: 'TUK3',
        '../import': [['import.bcbb2033.js', 'uRa7'], 'import.bcbb2033.js.map', 'uRa7'],
    ...
    A6uO: [
      function (require, module, exports) {
        ...
        var e = require('preact'),
          t = require('../app-state/getters'),
          o = require('preact/compat'),
          r = require('../app-state/active-profile-state'),
          a = require('./themes/theme'),
          i = require('../app-state'),
          s = require('../lib/atom'),
          n = require('./search-view'),
          m = require('./application')
        const u = (0, o.memo)(() => {
          const u = (0, s.useAtom)(i.glCanvasAtom),
            l = (0, a.useTheme)(),
            p = (0, o.useMemo)(() => (u ? (0, t.getCanvasContext)({theme: l, canvas: u}) : null), [l, u])
          return (0, e.h)(
            n.ProfileSearchContextProvider,
            null,
            (0, e.h)(m.Application, {
              activeProfileState: (0, r.useActiveProfileState)(),
              canvasContext: p,
              setGLCanvas: i.glCanvasAtom.set,
              setLoading: i.loadingAtom.set,
              setError: i.errorAtom.set,
              setProfileGroup: i.profileGroupAtom.setProfileGroup,
              setDragActive: i.dragActiveAtom.set,
              setViewMode: i.viewModeAtom.set,
              setFlattenRecursion: i.flattenRecursionAtom.set,
              setProfileIndexToView: i.profileGroupAtom.setProfileIndexToView,
              profileGroup: (0, s.useAtom)(i.profileGroupAtom),
              theme: l,
              flattenRecursion: (0, s.useAtom)(i.flattenRecursionAtom),
              viewMode: (0, s.useAtom)(i.viewModeAtom),
              hashParams: (0, s.useAtom)(i.hashParamsAtom),
              glCanvas: u,
              dragActive: (0, s.useAtom)(i.dragActiveAtom),
              loading: (0, s.useAtom)(i.loadingAtom),
              error: (0, s.useAtom)(i.errorAtom),
            }),
          )
        })
        exports.ApplicationContainer = u
      },
      {
        preact: 'aSor',
        '../app-state/getters': 'zEXv',
    ...
    K5F6: [
      function (require, module, exports) {
        'use strict'
        var e = require('preact'),
          o = require('./views/application-container'),
          d = require('./views/themes/theme')
        console.log(`speedscope v${require('../package.json').version}`),
          module.hot &&
            ...
            module.hot.accept()),
          (0, e.render)(
            (0, e.h)(d.ThemeProvider, null, (0, e.h)(o.ApplicationContainer, null)),
            document.body,
...
//# sourceMappingURL=speedscope.6f107512.js.map
