...
describe('dev', () => {
  ...
  describe('Beta Implementation', async () => {
    test('calls startDevServer with the correct arguments when the beta option is provided', async () => {
      // Given
      ...
      const devOptions = {...options, beta: true, 'theme-editor-sync': true}
