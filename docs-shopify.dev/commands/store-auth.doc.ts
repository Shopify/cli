...
const data: ReferenceEntityTemplateSchema = {
  name: 'store auth',
  description: `Starts a standard Shopify app OAuth flow against the specified store and stores an online access token for later use by \`shopify store execute\`.
